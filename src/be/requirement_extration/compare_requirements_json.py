...
# Carica i prompt (use absolute path relative to this file)
_module_dir = Path(__file__).parent
try:
    with open(_module_dir / "prompt_message.txt", "r", encoding="utf-8") as f:
        prompt_message = f.read()
    with open(_module_dir / "system_prompt.txt", "r", encoding="utf-8") as f:
